...
short(car_12).
double(car_12).
load(car_12,circle,1).
open(car_12).

has_car(train5,car_13).
nth_car(car_13,3).
shape(car_13,u_shaped).
short(car_13).
not_double(car_13).
load(car_13,circle,1).
open(car_13).
...
has_car(train1,car_54).
nth_car(car_54,4).
shape(car_54,rectangle).
short(car_54).
double(car_54).
load(car_54,triangle,1).
open(car_54).
